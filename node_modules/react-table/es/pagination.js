                    ...
                    React.createElement(
                        ...
                        (
                            () => {
                                ...
                                let clickHandler = (e, key) => {
                                    console.log('page onpress called')
                                    console.log(key)
                                    _this2.changePage(key);
                                }

                                for (let buttonIndex = 0; buttonIndex < pages; buttonIndex++) {
                                    pageButtons.push(React.createElement('div',
                                        page == buttonIndex  ? {className: '-pageButtonCurrent', key: buttonIndex}
                                            :
                                            {
                                ...
                                return React.createElement('div', {className: '-center'}, pageButtons);
                            }
                        ).call()
                    )
                ),
